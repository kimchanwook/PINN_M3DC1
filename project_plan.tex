...
\begin{notebox}
\textbf{Current status.} Version 0.1 establishes the repository backbone, seven-module dependency registry, parallel Python/MATLAB structure, scientific claim hierarchy, initial configuration, and reduced-MHD sign conventions. No numerical MHD solver or trained surrogate is yet claimed.
\end{notebox}
